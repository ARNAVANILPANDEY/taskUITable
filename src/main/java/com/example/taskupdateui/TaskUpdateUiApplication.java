...
public class TaskUpdateUiApplication {
    ...
    public String home(@RequestBody HashMap<String,String> readData) throws IOException, org.json.simple.parser.ParseException {
        /* *****************Reading**************************************** */
        ...
        String startDate=javaDate;
                //""+simpleformat2.format(javaDate);
